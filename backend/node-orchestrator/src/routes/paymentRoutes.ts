...
router.post('/process', validateProcessPayment, async (req: AuthenticatedRequest, res: Response) => {
  try {
...
router.post('/:id/refund', validatePaymentId, validateRefundPayment, async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id: paymentId } = req.params;
